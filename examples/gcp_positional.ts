/**
 * This example will make the first item in a `line.Message` the google `jsonPayload.message` for nice printing, with the remaining arguments positionally indexed as JSON.
 *
